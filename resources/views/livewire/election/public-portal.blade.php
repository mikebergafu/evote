<div class="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        ...
        <div class="text-center mb-12">
            <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">Cast Your Vote</h2>
            <p class="text-xl text-gray-600 dark:text-gray-400">Select an election and enter your voter ID to participate</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Check back later for upcoming elections</p>
                </div>
            @endforelse
        </div>
            ...
            <div class="max-w-2xl mx-auto">
                <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border-2 border-blue-500 dark:border-blue-600 p-8">
                    <div class="text-center mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Enter Your Voter ID</h3>
                        <p class="text-gray-600 dark:text-gray-400">You'll need your unique voter ID to cast your vote</p>
                    </div>
        ...
        <div class="mt-16 grid md:grid-cols-3 gap-6">
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Secure Voting</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Your vote is encrypted and anonymous. Device verification ensures one vote per person.</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Easy Process</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">Simple step-by-step voting process. Vote for each position one at a time.</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-2">Real-time Results</h4>
                <p class="text-gray-600 dark:text-gray-400 text-sm">View election results immediately after polls close. Transparent and verifiable.</p>
            </div>
        </div>
    </div>
</div>
