        ...
        <form wire:submit.prevent="createElection" class="space-y-8">
            <div class="grid lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <!-- Help Card -->
                    <div class="bg-gradient-to-br from-blue-500 to-purple-500 rounded-3xl shadow-xl p-6 text-white sticky top-24">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-lg rounded-2xl flex items-center justify-center mb-4">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <ul class="space-y-3 text-sm text-white/90">
                            <li class="flex items-start gap-2">
                                ...
                                Use clear, descriptive names for your election
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                Add at least 2 candidates before creating
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                Include candidate bios to help voters decide
                            </li>
                            <li class="flex items-start gap-2">
                                <svg class="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                </svg>
                                This device will be locked as the admin device
                            </li>
                        </ul>
                    </div>

                    <!-- Security Notice -->
                    <div class="bg-gradient-to-br from-orange-500 to-red-500 rounded-3xl shadow-xl p-6 text-white">
                        <div class="w-12 h-12 bg-white/20 backdrop-blur-lg rounded-2xl flex items-center justify-center mb-4">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold mb-2">Device Security</h3>
                        <p class="text-sm text-white/90 leading-relaxed">
                            ⚠️ <strong>Important:</strong> This device will become the only device authorized to manage this election. Make sure you have reliable access to it.
                        </p>
                    </div>

                    <!-- Stats Preview -->
                    <div class="bg-white dark:bg-[#1D1D1C] rounded-3xl shadow-xl border border-gray-200 dark:border-gray-800 p-6">
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4">Election Preview</h3>
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ count($candidates) }}</span>
                            </div>
