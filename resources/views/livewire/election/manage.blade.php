                        ...
                        @forelse($voters as $voter)
                            <div class="group bg-gray-50 dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-500 rounded-2xl p-4 transition-all">
                                <div class="flex justify-between items-start">
                                    ...
                                    <div class="flex gap-2">
                                        @if($voter->device_registered)
                                            <button wire:click="clearDeviceFingerprint({{ $voter->id }})" wire:confirm="Clear device registration for {{ $voter->name }}?" class="text-orange-500 hover:text-orange-700 transition-colors p-1 hover:bg-orange-50 dark:hover:bg-orange-900/20 rounded" title="Clear device">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/>
                                                </svg>
                                            </button>
